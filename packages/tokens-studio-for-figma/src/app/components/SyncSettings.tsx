...
console.log('AVAILABLE_PROVIDERS', typeof AVAILABLE_PROVIDERS, '***', AVAILABLE_PROVIDERS);
console.log('LIST_OF_PROVIDERS', typeof LIST_OF_PROVIDERS, '***', LIST_OF_PROVIDERS);
console.log('StorageProviderType', typeof StorageProviderType, '***', StorageProviderType);
